            ...
            for i in range(0, self.max_iterations):
                ...
                attackinstance.logger.logger.info(
                    ...
                    format(i, besttransformerindex, besttransfcall,
                           round(bestminscore, 4), attackinstance.classprednew,
                ...
                if (
                        self.sauthor.true_class == self.tauthor.true_class and self.sauthor.true_class != attackinstance.classprednew) or \
                        (
                                self.sauthor.true_class != self.tauthor.true_class and self.tauthor.true_class == attackinstance.classprednew):
