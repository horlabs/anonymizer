...
static llvm::cl::OptionCategory
    ToolingSampleCategory("Tooling AST NODE Types Extraction");
static llvm::cl::opt<int> OurCMDOption("featuretype",
...
public:
  ...
  CreateASTConsumer(clang::CompilerInstance &Compiler, llvm::StringRef InFile) {
    ...
    commandlineoption cmdoption =
        static_cast<commandlineoption>(OurCMDOption.getValue());
