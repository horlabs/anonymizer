...
{
	int ncase;
	int i,j,k,nans,n1rval1,n1rval2,n1rval3,n1rval4,n2rval1,n2rval2,n2rval3,n2rval4;
	...
	for(i=0;i<ncase;i++)
	{
		...
		res=checkCard(n1rval1,n1rval2,n1rval3,n1rval4,n2rval1,n2rval2,n2rval3,n2rval4);
		if(res>0)		
			printf("Case #%d: %d\n",i+1,res);
		else if(res==-2)
			printf("Case #%d: %s\n",i+1, "Bad magician!");
